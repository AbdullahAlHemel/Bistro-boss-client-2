...
const Footer = () => {
  ...
  return (
    <footer className="bg-neutral text-neutral-content">
      {/* Top Section */}
      <div className="footer p-10 md:flex md:justify-between md:items-start">
        {/* Logo & Description */}
      ...
      {/* Bottom Section */}
      <div className="footer-center p-4 border-t border-neutral-content/20 text-center">
        <p className="text-sm">
          © 2026 Bistro Boss Ltd. All rights reserved.
        </p>
      </div>
    </footer>
  );
